...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # The argument passed to inject will be yielded as the first argument to the block
    # the first time its executed. The second argument yielded to the block will be the 
    # first element of the object that called inject
  end
  ...
  #   # code to read 'file'
  #
  # Because we wanted the functionality inside of the block to be applied to the 
  # file output.
  #
